...
@Parameters(
    ...
    commandDescriptionKey = "get-tags.command-description")
public class GetTagsAmphoraClientCliCommandConfig extends AmphoraClientCliCommandConfig {

  public static final String COMMAND_NAME = "get-tags";

  @Parameter(
      descriptionKey = "get-tags.parameter.secret-id-description",
      converter = UUIDTypeConverter.class,
      required = true,
      arity = 1)
  private List<UUID> secretId;

  public GetTagsAmphoraClientCliCommandConfig(Option<AmphoraClientFactory> customClientFactory) {
