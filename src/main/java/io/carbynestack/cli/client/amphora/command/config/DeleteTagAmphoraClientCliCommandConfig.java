...
@Parameters(
    ...
    commandDescriptionKey = "delete-tag.command-description")
public class DeleteTagAmphoraClientCliCommandConfig extends AmphoraClientCliCommandConfig {

  public static final String COMMAND_NAME = "delete-tag";

  @Parameter(
      names = {"-i", "--secret-id"},
      descriptionKey = "delete-tag.option.secret-id-description",
      converter = UUIDTypeConverter.class,
      required = true)
  private UUID secretId;

  @Parameter(descriptionKey = "delete-tag.parameter.tag-key-description", required = true)
  private String tagKey;

  public DeleteTagAmphoraClientCliCommandConfig(Option<AmphoraClientFactory> customClientFactory) {
